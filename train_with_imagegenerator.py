...
image_generator = {'train': tf.keras.processing.image.ImageDataGenerator(rescale=1./127.5,
                        rotation_range=10,
                        height_shift_range=0.1,
                        ),
                   'val': tf.keras.preprocessing.image.ImageDataGenerator(rescale=1./127.5)}
# generator = {x: image_generator.flow_from_dataframe(dataframe=)}
